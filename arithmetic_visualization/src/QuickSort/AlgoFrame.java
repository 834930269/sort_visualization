...
public class AlgoFrame extends JFrame {
    ...
    private class AlgoCanvas extends JPanel{
        ...
        public void paintComponent(Graphics g){
            ...
            AlgoVisHelper.drawText(g2d,"快速排序.O(NlgN)",canvasWidth/2,(this.getBounds().height-canvasHeight),12);
            AlgoVisHelper.drawText(g2d,"每次排序将数据分为两半,一半比mid小,一半比mid大",canvasWidth/2,(this.getBounds().height-canvasHeight)+16,12);
            AlgoVisHelper.setColor(g2d, AlgoVisHelper.DeepOrange);
            AlgoVisHelper.drawText(g2d,"这是第一类快排.非严版,顺序扫描,小于swap,j++",canvasWidth/2,(this.getBounds().height-canvasHeight)+40,24);
